...
async function get(endpoint, params = {}) {
  ...
  // Always read body first so we get the real error message
...
export async function fetchH2H(team1Id, team2Id) {
  // Free tier doesn't support 'last' param — use date range instead
...
export async function fetchTeamForm(teamId, last = 5) {
  // Free tier doesn't support 'last' param — use date range
  const from = new Date();
