export const FIGHTERS = {
  malott: { name: "Mike Malott", nationality: "🇨🇦 Canada", division: "Welterweight", record: { w: 12, l: 2, d: 0 }, age: 32, reach: '74"', finishRate: "67%", lastResult: "KO/TKO", bio: "Knocked out Gilbert Burns in the R3 main event on Apr 19. On an 8-fight unbeaten streak inside the UFC. Kitchener, Ontario native with a powerful striking arsenal." },
  jourdain: { name: "Charles Jourdain", nationality: "🇨🇦 Canada", division: "Bantamweight", record: { w: 16, l: 7, d: 1 }, age: 27, reach: '71"', finishRate: "56%", lastResult: "Decision", bio: "One of the most exciting fighters on the roster. Beat Kyler Phillips by unanimous decision on Apr 19. Known for fan-friendly wars that always deliver." },
  herbert: { name: "Jai Herbert", nationality: "🇬🇧 UK", division: "Lightweight", record: { w: 13, l: 4, d: 0 }, age: 33, reach: '76"', finishRate: "77%", lastResult: "KO R1", bio: "Finished Mandel Nallo with a first-round KO at UFC Fight Night Apr 19. Birmingham native with devastating striking power and an elite finish rate." },
  jasudavicius: { name: "Jasmine Jasudavicius", nationality: "🇨🇦 Canada", division: "Women's Flyweight", record: { w: 12, l: 3, d: 0 }, age: 32, reach: '68"', finishRate: "42%", lastResult: "Decision", bio: "Grappling-heavy pressure fighter from Hamilton, Ontario. Beat Karine Silva by unanimous decision. Known for relentless pace and a smothering wrestling base." },
  ulberg: { name: "Carlos Ulberg", nationality: "🇳🇿 New Zealand", division: "Light Heavyweight Champion", record: { w: 10, l: 1, d: 0 }, age: 32, reach: '79"', finishRate: "90%", lastResult: "KO R1 — TITLE", bio: "KO'd Jiri Prochazka in R1 at UFC 327 to claim the Light Heavyweight title. Trains at City Kickboxing alongside Adesanya. One of the most powerful strikers in the division." },
  costa: { name: "Paulo Costa", nationality: "🇧🇷 Brazil", division: "Light Heavyweight", record: { w: 15, l: 3, d: 0 }, age: 33, reach: '72"', finishRate: "87%", lastResult: "KO R3", bio: "'Borrachinha' — former middleweight title challenger who nearly beat Adesanya. Moved to 205 and is thriving. KO'd Murzakanov at UFC 327 in a brutal brawl." },
  reyes: { name: "Dominick Reyes", nationality: "🇺🇸 USA", division: "Light Heavyweight", record: { w: 13, l: 5, d: 0 }, age: 35, reach: '77"', finishRate: "62%", lastResult: "Split Dec", bio: "Fontana, CA native who nearly dethroned Jon Jones for the Light Heavyweight title. Won a contentious split decision over Johnny Walker at UFC 327." },
  hokit: { name: "Josh Hokit", nationality: "🇺🇸 USA", division: "Heavyweight", record: { w: 10, l: 4, d: 0 }, age: 30, reach: '75"', finishRate: "60%", lastResult: "Decision", bio: "Wrestling-based heavyweight from Fresno, CA. Pulled a major upset over ranked contender Curtis Blaydes via unanimous decision at UFC 327 on Apr 12." },
};
